...
| Click-to-focus hook install, hit-test, clean unhook | `Win32ClickWatcherTest` under Wine; facade path (real injected click → focus returns) real `windows-latest` via `ClickToFocusWin32Check`, 2026-09-03 |
